...
exports.createTripValidator = [
    ...
    (0, express_validator_1.body)("kilometrajeSalida").optional().isNumeric().withMessage("El kilometraje debe ser un número"),
    (0, express_validator_1.body)("kilometrajeLlegada").optional().isNumeric().withMessage("El kilometraje debe ser un número"),
